...
import net.zetaeta.libraries.ZetaPlugin;
...
public class CommandManager {
	...
	public void registerCommandExecutor(Executor executor) {
		...
		for(Method m : executorMethods) {
			if(m.isAnnotationPresent(net.zetaeta.libraries.commands.CommandHandler.class)) {
				net.zetaeta.libraries.commands.CommandHandler annot = m.getAnnotation(net.zetaeta.libraries.commands.CommandHandler.class);
