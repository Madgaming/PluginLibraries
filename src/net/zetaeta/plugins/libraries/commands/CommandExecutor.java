...
public class CommandExecutor {
	...
	public CommandExecutor(ZetaPlugin plugin) {
		this.plugin = plugin;
	...
	public boolean onCommand(CommandSender sndr, Command cmd, String cmdlbl, String[] args) {
		...
		if(!permission.equals("")) {
			if(!checkPermission(sndr, permission)) {
				return true;
			}
		}
	...
	public void registerCommandExecutor(Executor executor) {
		...
		for(Method m : executorMethods) {
			if(m.isAnnotationPresent(net.zetaeta.plugins.libraries.commands.CommandHandler.class)) {
				net.zetaeta.plugins.libraries.commands.CommandHandler annot = m.getAnnotation(net.zetaeta.plugins.libraries.commands.CommandHandler.class);
